...
//		String hiddenno = request.getParameter("hiddenno");
        ...
        int salarymin =
				Integer.parseInt(request.getParameter("salarymin"));
        int salarymax =
				Integer.parseInt(request.getParameter("salarymax"));
        String salaryformcd = request.getParameter("salaryformcd");
        int begintime =
				Integer.parseInt(request.getParameter("begintime"));
        int endtime =
				Integer.parseInt(request.getParameter("endtime"));
        int establishdt =
				Integer.parseInt(request.getParameter("establishdt"));
        long capital =
				Long.parseLong(request.getParameter("capital"));
        ...
        int hiddenagemin =
				Integer.parseInt(request.getParameter("hiddenagemin"));
        int hiddenagemax =
				Integer.parseInt(request.getParameter("hiddenagemax"));
