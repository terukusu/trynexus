...
public class KyujinDao {
	...
	public int insert(Kyujin kyujin) throws IOException {
		...
		//	ps.setString(54, "now()");
			ps.setDate(53, (Date) kyujin.getupdatedt());
			ps.setString(54, "0");
	...
	public int update(Kyujin kyujin) throws IOException {
		...
		try (PreparedStatement ps = this.conn.prepareStatement(sql.toString())) {
			...
			//ps.setString(53, kyujin.getCreateuserid());
			//ps.setString(56, kyujin.getDeleteflag());
			ps.setDate(52, convertToSqlDate(kyujin.getupdatedt()));
	 ...
	 * @throws IOException
	 */
	public int delete(String no, String id) throws IOException {
		int count = 0;
