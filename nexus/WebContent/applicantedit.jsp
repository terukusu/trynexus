...
<body>
	...
	<div id="job_seeker">
		...
		<form method="post" action="/nexus/web/jobseeker-edit">
			  ...
			  <input type="text" name="id" value="<c:out value="${ seeker.id }" />">
				...
				<tr>
					...
					<td><input type="text" class="datepicker" name="birthdt"
						value="<fmt:formatDate value="${ seeker.birthdt }" pattern="yyyy-MM-dd"/>"></td>
				</tr>
				<tr>
					<th>性別</th>
				...
				<tr>
					<th>希望職種1</th>
					<td><input type="text" name="hopejob1"
						value="<c:out value="${ seeker.hopejob1 }" />"></td>
				</tr>
				<tr>
					<th>希望職種2</th>
					<td><input type="text" name="hopejob2"
						value="<c:out value="${ seeker.hopejob2 }" />"></td>
				</tr>
				<tr>
					<th>希望職種3</th>
					<td><input type="text" name="hopejob3"
						value="<c:out value="${ seeker.hopejob3 }" />"></td>
				</tr>
				<tr>
					<th>希望業種</th>
					<td><input type="text" name="hopejobcategory"
						value="<c:out value="${ seeker.hopejobcategory }" />"></td>
				</tr>
				<tr>
					<th>希望勤務地</th>
