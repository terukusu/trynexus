...
<body>
	...
	<div id="box">
		<form action="/nexus/web/reserve.html" method="post">
			...
			<input type="text" name="name1" required /> <input type="text"
				name="name2" required /> <select name="tantoustaffname" required>
			...
			</select> <input type="submit" class="main-b" name="send" value="検索">
		</form>
	</div>
		...
		<c:forEach var="jobseeker" items="${ list }">
			<tr>
				<form action="/nexus/web/jobseeker-info" method="post">
					<td><button class="mini_b mini_b_applilist" name="js_id"
