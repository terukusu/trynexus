	...
	<c:forEach var="message" items="${ messages }">
		...
		<tr>
			...
			<tr>
				...
				<input type="submit" value="求人No一覧" onclick="window.open('http://localhost:8080/nexus/jobsearch.jsp')"></td>

			</tr>
			<tr>
				<td>求職者No</td>
				<td><input type="text" name="jobseekerid" size="8">
				<input type="submit" value="求職者一覧" onclick="window.open('http://localhost:8080/nexus/applicant_list.jsp')"></td>
